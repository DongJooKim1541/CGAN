...
for epoch in range(num_epoch):
    for i, (images, label) in enumerate(data_loader):
        ...
        # print("real_images.size(): ", real_images.size()) # torch.Size([batch_size, 784])
        ...
        #print("label_encoded.size(): ",label_encoded.size()) # torch.Size([batch_size, 10])
        ...
        # print("z_concat.size(): ", z_concat.size()) # torch.Size([batch_size, 110])
        fake_images = generator(z_concat)
        # print("fake_images.size(): ", fake_images.size()) # torch.Size([batch_size, 784])
        fake_images_concat = torch.cat((fake_images, label_encoded), 1)
        # print("fake_images_concat.size(): ", fake_images_concat.size()) # torch.Size([batch_size, 794])
